...
export function FormTicket({customer}: FormTicketProps){
    ...
    return(
        ...
        >
            <label className="my-2 font-light text-lg">Nome do chamado:</label>
            < Input
            register={register}
            type="text"
            name="name"
            ...
            />
            <label className="font-light text-lg">Descreva o problema:</label>
            <textarea 
            className="w-full border-2 rounded-md h-24 resize-none px-2"
            placeholder="Relate objetivamente o problema"
            id="description"
            ...
            <button
            type="submit"
            className="bg-blue-500 rounded-md w-full h-11 px-2 text-white font-light"
            >
                Cadastrar
            </button>
